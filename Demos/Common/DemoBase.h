...
public:
    ...
    unsigned int getNumberOfStepsPerRenderUpdate() const
    {
        return m_numberOfStepsPerRenderUpdate;
    }
    void setNumberOfStepsPerRenderUpdate(unsigned int val)
    {
        m_numberOfStepsPerRenderUpdate = val;
    }
    ...
    GLint getContextMajorVersion() const
    {
        return m_context_major_version;
    }
    GLint getContextMinorVersion() const
    {
        return m_context_minor_version;
    }
    Shader& getShader()
    {
        return m_shader;
    ...
    void pointShaderEnd();
    SceneLoader::Scene& getScene()
    {
        return m_scene;
    }
    SimulationMethod& getSimulationMethod()
    {
        return m_simulationMethod;
    }

    int getRenderWalls() const
    {
        return m_renderWalls;
    }
    void setRenderWalls(int val)
    {
        m_renderWalls = val;
    }
    bool getPause() const
    ...
    std::vector<unsigned int>& getSelectedParticles()
    {
        return m_selectedParticles;
    }
    bool getUseParticleCaching() const
    {
        return m_useParticleCaching;
    }
    void setUseParticleCaching(bool val)
    {
        m_useParticleCaching = val;
    }
    SPH::DemoBase::SimulationMethodChangedFct getSimulationMethodChangedFct() const
    {
        return m_simulationMethodChangedFct;
    }
    void setSimulationMethodChangedFct(SPH::DemoBase::SimulationMethodChangedFct val)
    {
        m_simulationMethodChangedFct = val;
    }
    Real getPauseAt() const
    {
        return m_pauseAt;
    }
    void setPauseAt(Real val)
    {
        m_pauseAt = val;
    }
